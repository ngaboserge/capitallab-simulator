...
export function TeamTopHoldings() {
  const { state } = useTeamTrading()

  // Calculate actual holdings from team trades
  const holdings = useMemo(() => {
    ...
    // Process all team trades to calculate current holdings
  ...
  if (holdings.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle className="text-foreground">Team Portfolio Holdings</CardTitle>
          <p className="text-sm text-muted-foreground">Your team's current stock positions</p>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8">
            <p className="text-muted-foreground">No team holdings yet</p>
            <p className="text-sm text-muted-foreground mt-1">Execute your first team trade to see positions here</p>
          </div>
        </CardContent>
      </Card>
    )
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-foreground">Team Portfolio Holdings</CardTitle>
        <p className="text-sm text-muted-foreground">Your team's current stock positions ({holdings.length} stocks)</p>
      </CardHeader>
