          ...
          <div className="space-y-4">
            {concepts.map((concept) => {
              ...
              return (
                <Card
                  key={concept.id}
                  className={`${concept.color} cursor-pointer transition-all ${isActive ? 'shadow-lg scale-[1.02]' : 'hover:shadow-md'
                    }`}
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            >
              ...
              <ArrowDown className={`w-4 h-4 ml-2 transition-transform ${showProcess ? 'rotate-180' : ''
                }`} />
            </Button>
          </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          ...
          <CardContent className="space-y-4">
            <p className="text-blue-700">
              Now that you understand the basics, you can explore the interactive tutorial
              or learn about specific institutional roles.
            </p>
            <div className="flex gap-4">
              <Button onClick={() => router.push('/capitallab')} className="bg-blue-600 hover:bg-blue-700">
                <Play className="w-4 h-4 mr-2" />
                Interactive Tutorial
              </Button>
              <Button onClick={() => router.push('/capitallab')} variant="outline">
